<%@ Page Title="" Language="C#" MasterPageFile="~/ERM/Site.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="ERM.ERM.Registration" %>
...
<asp:Content ID="MyContent" ContentPlaceHolderID="MyContentPlaceHolder" runat="server">
  ...
  <br />
    ...
    <p><asp:Button ID="cmdSubmit" runat="server" Text="SUBMIT" OnClick="cmdSubmit_Click" /></p>
